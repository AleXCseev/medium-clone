    ...
    <nav class="navbar navbar-light">
        <div class="container">
            ...
            <ul class="nav navbar-nav pull-xs-right">
                <li class="nav-item">
                    <router-link class="nav-link" :to="{name: 'globalfeed'}" active-class="active">Home</router-link>
                </li>
                <template v-if="isLoggedIn">
                    ...
                    <li class="nav-item">
                        <router-link class="nav-link" :to="{name: 'userProfile', params: {slug: currentUser.username}}" active-class="active">
                            <img :src="currentUser.image" alt="" class="user-pic"> &nbsp; {{currentUser.username}}
                        </router-link>
                    </li>
                </template>
    ...
    name: "AppTopbar",
     computed: {
        ...mapGetters({
            ...
            isAnonymus: getterTypes.isAnonymous
        }),
    }
}
</script>